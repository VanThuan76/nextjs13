import TraderStatus from "@/components/TraderStatus/TraderStatus";
interface IManagerInfor {
  parcelCode: string;
}
const ManagerInfor = ({ parcelCode }: IManagerInfor) => {
  return (
    <div className="flex flex-col p-4 bg-white rounded-[15px] shadow-sd2 gap-[10px]">
      ...
      <div className="flex flex-col p-[10px] bg-cgray-200 rounded-[10px] gap-2">
        ...
        <div className="flex flex-row justify-between">
          <span className="text-sm text-cgray-600 font-semibold">Email</span>
          <span className="text-sm text-cgray-600 font-semibold">
            test@gmail.com
          </span>
        </div>
        <div className="flex flex-row justify-between">
          ...
          <span className="text-sm text-cgray-600 font-semibold">Nam</span>
        </div>
      </div>
      <div className="flex flex-col p-[10px] bg-cgray-200 rounded-[10px] gap-2">
        <div className="flex flex-row justify-between">
        ...
        <div className="flex flex-row justify-between">
          <span className="text-sm text-cgray-600 font-semibold">Khác</span>
          <span className="text-sm text-cgray-600 font-semibold">
            Kinh nghiệm 10 năm
          </span>
        </div>
      ...
      <div className="flex flex-col p-[10px] bg-cgray-200 rounded-[10px] gap-2">
        <div className="flex flex-row justify-between items-center">
          ...
          <TraderStatus isAccepted></TraderStatus>
        </div>
        <div className="flex flex-row justify-between">
          <span className="text-sm text-cgray-600 font-semibold">
            Ngày tham gia
