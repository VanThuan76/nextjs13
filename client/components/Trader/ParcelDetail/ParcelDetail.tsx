...
import ParcelBasisInfor from "../ParcelDetail/PacelInfo/ParcelInfo";
import ParcelGoods from "../ParcelDetail/ParcelGoods/ParcelGood";
import ParcelSave from "../ParcelDetail/ParcelSave/ParcelSave";
import ParcelWeight from "../ParcelDetail/ParcelWeight/ParcelWeight";
import PreviewLayout from "@/app/Trader/[id]/preview/layout";
import TraderPage from "@/app/Trader/[id]/preview/page";

interface IParcelDetail {
...
const ParcelDetail = ({
  ...
  const onClosePreview = () => {
    previewRef.current?.classList.toggle("trader-hidden-animation__preview");
  ...
  return (
    <main className="xs:pl-0 pl-1 overflow-y-scroll flex-grow w-full flex flex-col gap-5 trader-parcel pr-1">
      <ParcelBasisInfor
      ...
      {isPreview && (
        <div
          ref={previewRef}
          className="absolute top-0 left-0 right-0 bottom-0 trader-animation__preview"
        >
          <PreviewLayout>
            <button
            ...
            <TraderPage {...previewProps}></TraderPage>
          </PreviewLayout>
        </div>
      )}
    </main>
